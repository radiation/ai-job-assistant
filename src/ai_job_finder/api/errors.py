...
def install_error_handlers(app: FastAPI) -> None:
    ...
    async def handle_domain_error(request: Request, exc: DomainError) -> Response:
        status_code_by_code = {
            ...
            "oversized_response": 413,
            "no_provider_detected": 422,
            "ambiguous_candidates": 409,
            "greenhouse_validation_unavailable": 503,
            "source_detection_approval_failed": 409,
            "sync_failure_after_source_creation": 502,
